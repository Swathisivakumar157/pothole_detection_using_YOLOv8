...
model = YOLO(
    r"D:\Projects\Pothole_Detection\models\best.pt"
)  # or another version of YOLOv8 (e.g., yolov8s.pt for small)

# Load the video file
input_video_path = r"D:\Projects\Pothole_Detection\test\test3.mp4"
output_video_path = r"D:\Projects\Pothole_Detection\Output\output.mp4"
